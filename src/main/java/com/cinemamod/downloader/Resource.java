...
public final class Resource {
    ...
    public static String getJcefUrl(String cefBranch, String platform) {
        return "https://cinemamod-libraries.ewr1.vultrobjects.com/jcef/%s/%s".formatted(cefBranch, platform);
    }

    public static String getJcefPatchesUrl(String cefBranch, String platform) {
        return "https://cinemamod-libraries.ewr1.vultrobjects.com/jcef-patches/%s/%s".formatted(cefBranch, platform);
    }
}
